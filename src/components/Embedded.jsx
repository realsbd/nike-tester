  ...
  const form = useRef();
    ...
    return (
      ...
      <form ref={form} onSubmit={sendEmail} className='mt-20 w-full max-w-lg'>
        <h4 className='text-center font-bold mt-3 mb-3'> Apply here</h4>
        <div className="">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div>
            <label className=" text-gray-700" htmlFor="city">City</label>
          ...
          <div>
            <label className=" text-gray-700" htmlFor="state">State</label>
        ...
        <div className="mt-6 mb-5">
          <button type="submit" className="bg-blue-500 text-white p-3 rounded-md w-100 hover:bg-blue-600">Send Details</button>
        </div>
      </form>
    </div>
